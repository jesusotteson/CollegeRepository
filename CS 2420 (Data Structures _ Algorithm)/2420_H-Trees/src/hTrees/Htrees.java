...
public class Htrees {
	...
	public static void drawH(double x, double y, double size) {
		...
		//StdDraw.line(x1, y, x1, y0); // Chair Adjustment
		StdDraw.line(x0, y1, x1, y0); // Triangle Adjustment
		StdDraw.line(x1, y0, x0, y0); // Triangle Adjustment
		StdDraw.line(x0, y0, x0, y1); // Triangle Adjustment
		//StdDraw.line(x0, y, x, y); // connect the two vertical segments of the H
	}
