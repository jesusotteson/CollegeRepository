		...
		public void setTile(ArrayList<Tile> deck, int i) {
			...
			if(i > 4 && i < 20)
			{
				...
				for(int j = 1; j < 4; j++)
				{
					...
					if(j == 3)
					{
						deck.get(i).setLocation((xCord) - (tileWidth + zz), ((yCord) + (tileWidth - zz + 10)));
						deck.get(i).addMouseListener(this);
						add(deck.get(i));
						i++;
						...
						for(j = 1; j < 4; j++)
						{
							...
							if(j == 3)
							{
								deck.get(i).setLocation((xCord) - (tileWidth + zz), (yCord - zz + 20)); 
								deck.get(i).addMouseListener(this);
								add(deck.get(i));
								i++;
								...
								for(j = 1; j < 4; j++)
								{
									...
									if(j == 3)
									{
										deck.get(i).setLocation((xCord) - (tileWidth + zz), (yCord) - (tileWidth + 10) ); 
										deck.get(i).addMouseListener(this);
										add(deck.get(i));
										i++;
										for(j = 1; j < 4; j++)
