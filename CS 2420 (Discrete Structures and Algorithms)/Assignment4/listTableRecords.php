...
$query = "SELECT * FROM StateStats;";      /* variable $query to hold SQL statement */

include 'queryResult.php';          /* include file to process $query statement */

while ($row = mysqli_fetch_array($return)) {            /* display each table row returned from select statement */
    echo "".$row[0]."<b> | </b>".$row[1]."<b> | </b>".$row[2]."<b> | </b>".$row[3]."<b> | </b>".$row[4]."<b> | </b>".$row[5]."<b> | </b>".$row[6]."<b> | </b>".$row[7]."<b> | </b>".$row[8]."<b> | </b>".$row[9]."<b> | </b>".$row[10]."<br><br>";
}
?>